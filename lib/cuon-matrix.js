...
class Vector3 {
    ...
    /**
      ...
      */
    add(other) {
        this.elements.forEach((v, i, a) => a[i] = v + other.elements[i]);
    ...
    /**
      ...
      */
    div(scalar) {
        this.elements.forEach((v, i, a) => a[i] = v / scalar);
    ...
    static dot(other1, other2) {
        ...
        other1.elements.forEach((v, i) => d += v * other2.elements[i]);
    ...
    static cross(other1, other2) {
        ...
        let v1x = other1.elements[0];
        let v1y = other1.elements[1];
        let v1z = other1.elements[2];

        let v2x = other2.elements[0];
        let v2y = other2.elements[1];
        let v2z = other2.elements[2];

        let v3x = (v1y * v2z) - (v1z * v2y);
        let v3y = -((v1x * v2z) - (v1z * v2x));
